...
const HomeLoan = () => {
  ...
  return (
    <div className="EducationLoan">
      <section className="homeLoanBg position-relative">
        <div data-aos="flip-right" className="position-absolute textContainer">
          ...
          <div className=" rounded-4 py-4 px-5 d-flex flex-column align-items-start">
            {/* <div className="d-flex gap-3 mb-5 mt-3">
              ...
              >
                <option value="Undergraduate Loan">Home Loan</option>
        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-4 col-md-12 col-12">
              ...
              >
                <img src="/hl.webp" alt="" className="img-fluid" />
              </div>
            </div>
          </div>
        </div>
 ...
 */}
      ...
      <section className="EducationLoanSection_13 my-5 px-lg-0 px-md-0 px-4">
        <EducationLoanTitle
