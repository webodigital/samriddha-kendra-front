...
const Privacy_policy = () => {
  return (
    <div className="privacy font-inter">
      <center className="mt-7 bg-dark-blue text-white p-5">
        <h1 className="fw-bolder font-inter">Privacy Policy</h1>
      </center>
      <div className="container fs-18 my-5 px-5">
        <p>
          This Privacy Notice for Samriddh Kendra operated by Creditbucket
          Technologies Private Limited (we', 'us', or 'our'), describes how and
        ...
        <ul className="my-5">
          ...
          <li>
            ...
            services. We at SAMRIDDH KENDRA are committed to protecting the
            privacy and security of its users (“you”, “your”, “user(s)”, or
            “subscriber(s)”). Your privacy is important and maintaining your
            trust is paramount to us. This Privacy Policy (“Privacy Policy”)
        ...
        <h2 className="mt-5">What personal information do we process?</h2>
        <p>
          When you visit, use, or navigate our Services, we may process personal
          information depending on how you interact with us and the Services,
          the choices you make, and the products and features you use. Lear more
        ...
        <p>
          ...
          outside sources. Lear more about information collected from other
          sources.
        </p>

        <h2 className="mt-5">How do we process your information?</h2>
        <p>
        ...
        <h2 className="mt-5">How do we keep your information safe?</h2>
        <p>
        ...
        <h2 className="mt-5">What are your rights?</h2>
        <p>
          We have adequate organisational and technical processes and procedures
          in place to protect your personal information. However, no electronic
          transmission over the internet or information storage technology can
        ...
        <h2 className="mt-5">How do you exercise your rights?</h2>
        <p>
        ...
        <h1 className="mt-5">CONTENTS NAVIGATION</h1>
        <ol>
          ...
          <div className="p-4">
            ...
            <div className="mt-3">
              ...
              <p>
                ...
                instrument. All payment data is handled and stored by [payment
                processor].
              </p>
        ...
        <h2 className="mt-4">Google API</h2>
        <p>
          ...
          Information collected from other sources We may collect limited data
        ...
        <div className="mt-5">
          ...
          <p>
            At SAMRIDDH KENDRA, we prioritize the security of your personal
            information. We have implemented a comprehensive set of technical
            and organizational measures to protect your data from unauthorized
            access, disclosure, alteration, or destruction. These measures
            include:
          </p>
          <ul>
            <li>
              <strong>Encryption:</strong> We use encryption technology to
              safeguard sensitive personal data during transmission and storage.
            </li>
            <li>
              <strong>Access Controls:</strong> Access to your personal data is
              limited to authorized personnel only, who require this information
            ...
            <li>
              ...
              potential risks to our data security practices.
            </li>
            <li>
              <strong>Data Minimization:</strong> We limit the collection of
              personal data to what is necessary for the purposes outlined in
              this policy.
            </li>
          </ul>
          <p>
            We continually review and enhance our security practices to ensure
            they meet or exceed the standards set forth by the Information
            Technology Act, 2000, and other applicable regulations.
          </p>

          {/* Breach Notification Section */}
          <h2>3. BREACH NOTIFICATION</h2>
          <p>
            In the event of a data breach that poses a risk to your personal
            information, we will take immediate action to contain and mitigate
            the breach. Our breach notification process includes:
          </p>
          <ul>
            <li>
              <strong>Assessment:</strong> We will assess the nature and impact
              of the breach, determining the data involved and any potential
              harm to affected individuals.
            </li>
            <li>
              <strong>Notification:</strong> If a breach occurs, we will notify
              affected users without undue delay, providing information about
              the nature of the breach, the data affected, and steps you can
              take to protect yourself.
            </li>
            <li>
              <strong>Regulatory Reporting:</strong> We will also report the
              breach to the relevant authorities, as required under the
          ...
          <p>
            We take breaches seriously and will work diligently to rectify any
            security incidents to prevent future occurrences.
          </p>
        </div>

        <h2 className="mt-5">
          4. Our Platform and Services are primarily available for use within
          India only.
        </h2>
        ...
        <p>
          ...
          Your continued use of out Platform is an affirmation that you have
          read the privacy policy, understand it, assent and consent to its
          terms and conditions, including subsequent changes and amendments. If
          you do not agree to the terms, you are requested not to use or access
          our website or mobile application.
        </p>

        <p>
          <b>
            We strictly adhere to the requirements of the data protection law
            established in India and this Privacy Policy is published in
            accordance with:
          </b>
        </p>
        <p>
          Section 43A of the Information Technology Act, 2000 (“IT Act”); <br />{" "}
          ...
          (the “SDPI Rules”); <br /> and Rule 3 of the Information Technology
          (Intermediary Guidelines) Rules, 2011 (as amended). <br /> This
          Privacy Policy describes our privacy practices for all websites,
          products and services that are linked to it. <br /> However, this
          Privacy Policy does not apply to those affiliates and partners that
          have their own privacy policy. <br /> In such situations, we recommend
          that you read the privacy policy on the applicable website. <br /> Any
          capitalized terms not defined hereunder shall hold the same definition
          as provided under the Terms of Service. The Platform is only for use
        ...
        <div className="container mt-5">
          ...
          <h2>5. INTERNATIONAL STANDARDS</h2>
          <p>
            We are committed to maintaining high standards of data protection
            and privacy. While we operate in compliance with Indian laws, we
            also aim to adhere to international best practices, including:
          </p>
          <ul>
            <li>
              <strong>General Data Protection Regulation (GDPR):</strong>{" "}
              Although primarily applicable to organizations operating within
              the European Union, we align our practices with GDPR principles
              where feasible. This includes:
              <ul>
                <li>
                  <strong>Data Subject Rights:</strong> Respecting your rights
                  to access, correct, and delete your personal data.
                </li>
                <li>
                  <strong>Data Protection by Design and Default:</strong>{" "}
                  Implementing appropriate technical and organizational measures
                  to ensure that data protection principles are integrated into
                  our processing activities from the outset.
                </li>
              </ul>
            </li>
            <li>
              <strong>ISO/IEC 27001:</strong> We strive to comply with this
              international standard for information security management
              systems, which provides a framework for managing sensitive company
              and customer information.
            </li>
          </ul>
          <p>
            By adopting these international standards, we aim to enhance our
            commitment to protecting your privacy and building trust in our
            services.
          </p>
        </div>

        <h2 className="mt-5">6. HOW DO WE PROCESS YOUR INFORMATION?</h2>
        <p>
          We process your information to provide, improve, and administer our
          Services, communicate with you, for security and fraud prevention, and
          to comply with law. We may also process your information for other
        ...
        <ul>
          <li>
            ...
            and otherwise manage user accounts. We may process your information
        ...
        <p>
          ...
          us maintain the security of our Services and your account, prevent
          crashes, fix bugs, save your preferences, and assist with basic site
          functions. We also permit third parties and service providers to use
          online tracking technologies on our Services for analytics and
          advertising, including to help manage and display advertisements, to
          tailor advertisements to your interests, or to send abandoned shopping
          ...
          which may appear either on our Services or on other websites. Specific
          information about how we use such technologies and how you can refuse
          certain cookies is set out in our Cookie Notice
        </p>

        <h2 className="mt-5">9. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
        <p>
        ...
        <h2 className="mt-5">10. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
        <p>
        ...
        <h2 className="mt-5">11. DO WE COLLECT INFORMATION FROM MINORS?</h2>
        <p>
          We do not knowingly collect data from or market to children under 18
          years of age. We do not knowingly collect, solicit data from, or
          market to children under 18 years of age, nor do we knowingly sell
          such personal information. By using the Services, you represent that
          you are at least 18 or that you are the parent or guardian of such a
          minor and consent to such minor dependent's use of the Services. If we
        ...
        <p>
          ...
          'HOW CAN YOU CONTACT US ABOUT THIS NOTICE? below. However, please note
          ...
          lawful processing grounds other than consent. Opting.out of
          marketing_and.promotional_communications: You can unsubscribe from our
          marketing and promotional communications at any time by clicking on
          ...
          at Support@samriddhkendra.in.
        </p>
        <h2 className="mt-5">13. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
        <p>
        ...
        <h2 className="mt-5">14. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
        <p>
        ...
        <h1 className="mt-5">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h1>
        <p>
          <b>
